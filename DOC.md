...
### Features
The structures work similar in a class in object-oriented programming
...
Parameters:
- `NameOfEnumeration` - The name of the enumeration to which the attribute belongs
...
Parameters:
- `NameOfEnumeration` - The name of the enumeration to which the attribute belongs
- `NameOfOption`      - The name of the option to which the value is assigned to
- `NameOfAttribute`   - The name of the attribute for which the value is assigned
...
- `LogicalStatementString` - The logical statement of the requirement written out as a string
...
Parameters:
- `ConstraintID`           - ID of the constraint to which the condition belongs
- `LogicalStatementString` - The logical statement of the condition written out as a string
...
- `FormulaString`   - The formula written out as a string
...
Any combination that comply to some 'allow'-line in the table, is a valid combination for the product.
...
- `CompleteString`   - Complete formula as string
- `LeftString`       - Left side of the formula as string
- `Operator`         - Binary Operator as string
- `RightString`      - Right side of the formula as string
...
- `CompleteString`   - Complete function with argument as string
- `TypeOfFunction`   - Type of function as string
- `Argument`         - Argument of the function as string
