...
```
This will automatically save the file as an ASP instance in the `asp-instances` folder.
...
### Solving
The files generated by the parser are located in the `asp-instances` directory.
...
The `encoding-clingo-kids.lp` contains all features of the kids bike.
To run
```
clingo encodings-clingo-kids.lp asp-instances/kids-bike.lp
```

Similarly, for the city and travel bike run
```
clingo encoding-clingo-city.lp asp-instances/city-bike.lp
```
```
clingo encoding-clingo-travel.lp asp-instances/travel-bike.lp
```
...
```
fclingo encoding-fclingo-kids.lp asp-instances/kids-bike.lp 0
fclingo encoding-fclingo-city.lp asp-instances/city-bike.lp 0
fclingo encoding-fclingo-travel.lp asp-instances/travel-bike.lp 0
```
