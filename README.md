...
```
clingo encodings-clingo-core.lp encodings/clingo-partonomy.lp examples/asp/city-bike.lp
```
```
clingo encodings-clingo-core.lp encodings/clingo-partonomy.lp encodings/clingo-numeric.lp examples/asp/travel-bike.lp
```
...
fclingo encodings/fclingo-core.lp  encodings/fclingo-partonomy.lp examples/asp/city-bike.lp 0
fclingo encodings/fclingo-core.lp  encodings/fclingo-partonomy.lp encodings/fclingo-numeric.lp examples/asp/travel-bike.lp 0
```
